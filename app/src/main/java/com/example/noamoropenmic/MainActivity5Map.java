...
public class MainActivity5Map extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_activity5_map);
                ...
                try {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Intent i = new Intent(MainActivity5Map.this,MapActivity.class);
                            i.putExtra("lat",lat);
                            i.putExtra("lng",lng);
